...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 col-md-4 col-md-offset-2 col-lg-4 col-lg-offset-2 body-padding">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 bottom-margin cursor-pointer" onclick="window.location='/weekChart?canteenId=1';">
                    ...
                    <div class="col-sm-12 bottom-margin cursor-pointer" onclick="window.location='/weekChart?canteenId=2';">
                        <div class="alignment-wrapper float-right">
