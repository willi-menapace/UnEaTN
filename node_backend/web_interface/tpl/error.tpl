...
<body style="background-color: #440000">
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-sm-offset-0 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2 body-padding">
            <div class="alignment-wrapper txt-center">
                <span class="txt-center txt-bold"><p style="margin-bottom: 25px; font-size: 40px">☠ ERRORE (:errorStatus:) ☠</p></span>
                <p>(:errorDescription:)</p>
                <p></p>
                <p>Si prega di segnalare l'errore al team di sviluppo.</p>
            </div>
        </div>
    </div>
    <!-- FOOTER -->
