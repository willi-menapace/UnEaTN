...
module.exports = class AddWaitingTimeHandler extends ApplicationHandlerSkeleton{
    ...
    processRequest(res, attributes) {
        ...
        if(currentDate.getDay() == 0){
            ...
            weeklyDay = currentDate.getDay() - 1;
        }
        openingHourDBHelper.getOpeningHourByCanteenIdAndDay(attributes.getCanteen().canteenId, weeklyDay).then(function(canteenSchedule){
            if(canteenSchedule !== null) {
